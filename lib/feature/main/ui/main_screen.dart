...
import 'package:films/core/ui/widgets/content_container.dart';
import 'package:films/core/ui/widgets/custom_title.dart';
import 'package:films/core/ui/widgets/horizontal_content_container.dart';
import 'package:films/feature/search/presentation/profile_settings_cubit/list_film_cubit.dart';
          ...
          ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return ContentContainer(
                  onSave: () => context.read<ListFilmCubit>().saveLatest(film),
                  film: film,
                  navigateToFilm: (value) => navigateToFilm
                      .call(value)
                      .whenComplete(() => context.read<ListFilmCubit>().init()),
                );
              },
              separatorBuilder: (context, index) => const SizedBox(
                    height: 20,
